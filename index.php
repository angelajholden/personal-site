	...
	<main id="skip-nav" class="wrap">
		...
		<section class="content">
			<article class="yellow_box">
				...
				<p>First impressions matter. Engaging, beautiful design gets eyes on your app, but aesthetics are only
					part of the puzzle. Creating a seamless, responsive interface that sets it apart begins with solid
					code, strategic integration of new technologies, and measurable performance goals. Experiential,
					human-driven design, inside and out.</p>
		...
		<section class="content">
			<aside class="blue_box">
				...
				<p>Anticipating the needs and actions of users allows you to create a system that feels intuitive and
					easy.</p>
			...
			<aside class="blue_box">
				...
				<p>Designing for humans means designing for all humans. Inclusivity is a catalyst for innovation, not a
					barrier.</p>
