  ...
  <body class="home">
    ...
    <main id="skip-nav" class="wrap">
      <header class="header">
        ...
        <a class="button" href="mailto:info@angelajholden.com"
          >Interested? <span>Let's talk.</span></a
        >
      ...
      <section class="content">
        ...
        <article class="svg_box">
          ...
          <nav class="social_profiles">
            ...
            <a
              href="https://open.spotify.com/user/1237470859?si=rxNK8-KxRL2u8YGSAeAgGw"
            >
              <span class="svg_bubble"
                ><svg
                  aria-label="hidden"
